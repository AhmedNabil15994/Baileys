            ...
            if(dialogs.length){
                await Promise.all(Object.values(dialogs).map(async (dialog) => {
                    ...
                    dialogsArr.push({
                        ...
                        'conversationTimestamp': dialog.conversationTimestamp > 0 ? dialog.conversationTimestamp / 1000 : 0,
                        'last_time': dialog.conversationTimestamp > 0 ? dialog.conversationTimestamp / 1000 : 0,
        ...
        try {
            ...
            if(selected.hasOwnProperty('id')){
                ...
                chatObj= {
                    ...
                    'conversationTimestamp': selected['conversationTimestamp'] > 0 ? selected['conversationTimestamp'] / 1000 : 0,
                    'last_time': selected['conversationTimestamp'] > 0 ? selected['conversationTimestamp'] / 1000 : 0,
