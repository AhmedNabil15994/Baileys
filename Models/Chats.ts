            ...
            if(dialogs.length){
                await Promise.all(Object.values(dialogs).map(async (dialog) => {
                    ...
                    dialogsArr.push({
                        ...
                        'conversationTimestamp': dialog.conversationTimestamp > 0 ? dialog.conversationTimestamp / 1000 : null,
                        'last_time': dialog.conversationTimestamp > 0 ? dialog.conversationTimestamp / 1000 : null,
        ...
        try {
            ...
            if(selected.hasOwnProperty('id')){
                ...
                chatObj= {
                    ...
                    'conversationTimestamp': selected['conversationTimestamp'] > 0 ? selected['conversationTimestamp'] / 1000 : null,
                    'last_time': selected['conversationTimestamp'] > 0 ? selected['conversationTimestamp'] / 1000 : null,
