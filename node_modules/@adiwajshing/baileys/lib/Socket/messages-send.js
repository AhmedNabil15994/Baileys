...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata },type=null) => {
    ...
    return {
        ...
        sendOFFMessage: async (jid, content, options = {},messageId) => {
            var _a, _b;
            const userJid = authState.creds.me.id;
            const fullMsg = await (0, Utils_1.generateWAMessage)(jid, content, {
                logger,
