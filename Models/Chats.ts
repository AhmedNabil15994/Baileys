            ...
            if(dialogs.length){
                await Promise.all(Object.values(dialogs).map(async (dialog) => {
                    ...
                    dialogsArr.push({
                        ...
                        'conversationTimestamp': dialog.conversationTimestamp ? parseInt(dialog.conversationTimestamp) / 1000 : 0,
                        'last_time': dialog.conversationTimestamp ? parseInt(dialog.conversationTimestamp) / 1000 : 0,
        ...
        try {
            ...
            if(selected.hasOwnProperty('id')){
                ...
                chatObj= {
                    ...
                    'conversationTimestamp': selected['conversationTimestamp'] ? parseInt(selected['conversationTimestamp']) / 1000 : 0,
                    'last_time': selected['conversationTimestamp'] ? parseInt(selected['conversationTimestamp']) / 1000 : 0,
