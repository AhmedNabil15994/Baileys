    ...
    if (protocolMsg) {
        ...
        switch (message.messageStubType) {
            ...
            case Types_1.WAMessageStubType.GROUP_CHANGE_ANNOUNCE:
                ...
                ev.emit('group.update', [{id:jid,announce: announceValue === 'true' || announceValue === 'on'}]);
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_RESTRICT:
                const restrictValue = (_c = message.messageStubParameters) === null || _c === void 0 ? void 0 : _c[0];
                // emitGroupUpdate({ restrict: restrictValue === 'true' || restrictValue === 'on' });
                ev.emit('group.update', [{id:jid,restrict: restrictValue === 'true' || restrictValue === 'on'}]);
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_SUBJECT:
                const name = (_d = message.messageStubParameters) === null || _d === void 0 ? void 0 : _d[0];
                chat.name = name;
                ev.emit('group.update', [chat]);
                // emitGroupUpdate({ subject: name });
                break;
            case Types_1.WAMessageStubType.GROUP_CHANGE_DESCRIPTION:
                const description = (_d = message.messageStubParameters) === null || _d === void 0 ? void 0 : _d[0];
