...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        if ('content' in message) {
            msg.hydratedContentText = message.content;
        }
        else {
        ...
        m = {
            templateMessage: {
                // fourRowTemplate: message.templateButtons,
                hydratedTemplate: msg
            }
        };        
        m = { viewOnceMessage: { message: m } };    
    }
    else if ('linkText' in message && !!message.linkText) {
        let msg = {};
        if ('linkText' in message) {
            msg['text'] = message.linkText;
        }
        if ('matchedText' in message) {
            msg['matchedText'] = message.matchedText;
        }
        if ('title' in message) {
            msg['title'] = message.title;
        }
        if ('previewType' in message) {
            msg['previewType'] = 0;
        }

        m = { extendedTextMessage: msg};        
    }
    else if ('groupText' in message && !!message.groupText) {
        let msg = {};
        if ('inviteLinkGroupTypeV2' in message) {
            msg['inviteLinkGroupTypeV2'] = message.inviteLinkGroupTypeV2;
        }
        if ('jpegThumbnail' in message) {
            msg['jpegThumbnail'] = message.jpegThumbnail;
        }
        if ('title' in message) {
            msg['title'] = message.title;
        }
        ...
        if ('groupText' in message) {
            msg['text'] = message.groupText;
        }
        
        m = { extendedTextMessage: msg};        
    }
    else if ('catalogText' in message && !!message.catalogText) {
        let msg = {};
        msg['inviteLinkGroupTypeV2'] = 0;
        if ('canonicalUrl' in message) {
            msg['canonicalUrl'] = message.canonicalUrl;
        }
        if ('jpegThumbnail' in message) {
            msg['jpegThumbnail'] = message.jpegThumbnail;
        }
        ...
        if ('catalogText' in message) {
            msg['text'] = message.catalogText;
        }
        ...
        let msg = {};
        if ('values' in message.poll) {
            msg['options'] = message.poll.values;
        }
        if ('name' in message.poll) {
            msg['name'] = message.poll.name;
        }
        if ('selectableOptionsCount' in message.poll) {
            msg['selectableOptionsCount'] = message.poll.selectableOptionsCount;
        }else{
            msg['selectableOptionsCount'] = 0;
        }
         msg['contextInfo'] = {
            'mentionedJid': [],
            'disappearingMode': {
